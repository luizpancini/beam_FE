...
if isempty(varargin) % Unpack all data
    ...
    switch lower(varargin{1})
        case 'global_matrices'
            ...
            cf_on_element = edata.cf_on_element{e};
            % Outputs:
            varargout = {e_dof_range,L0,beam,T0,Jac,E_of_xi,G_of_xi,A_of_xi,J_of_xi,Gamma_of_xi,Iyy_of_xi,Izz_of_xi,Ksy_of_xi,Ksz_of_xi,Gamx_of_xi,Gamy_of_xi,Gamz_of_xi,fx_of_xi,qy_of_xi,qz_of_xi,mx_of_xi,fa_of_xi,ql_of_xi,qt_of_xi,tq_of_xi,bm_of_xi,cfl_of_xi,cft_of_xi,cf_on_element};     
        ...
        case 'outputs'
            ...
            Gamz_of_x = edata.Gamz_of_x{e};
            % Outputs:
            varargout = {e_dof_range,L0,x1,beam,R0,T0,Jac,x_vec_nodes,x_vec_interp,x0,y0,z0,E_of_x,G_of_x,A_of_x,J_of_x,Gamma_of_x,Iyy_of_x,Izz_of_x,Ksy_of_x,Ksz_of_x,Gamx_of_x,Gamy_of_x,Gamz_of_x};
        case 'plot_structure'
            % Geometry-related
            e_node_range = edata.e_node_range{e};
            beam = edata.beam{e};
