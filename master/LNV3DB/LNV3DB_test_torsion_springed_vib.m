...
% Check torsional vibration of clamped-springed beam
...
transc_eq = @(x) mu*tan(x)+x;           % Transcendental equation from clamped-springed torsionally vibrating beam
