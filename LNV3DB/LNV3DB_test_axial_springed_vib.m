...
% Check longitudinal vibration of clamped-springed beam
...
transc_eq = @(x) mu*tan(x)+x;           % Transcendental equation from clamped-springed longitudinally vibrating beam
for i=1:FEMdata.N_modes
    tau = (2*i-1)*pi/2; % Initial guess
