function [FEMdata,Px_of_x,Py_of_x,Pz_of_x,Pa_of_x,Pl_of_x,Pt_of_x,Mx_of_x,My_of_x,Mz_of_x,Ml_of_x,Mt_of_x,Tq_of_x,Bm_of_x,CSx_of_x,CSy_of_x,CSz_of_x,CSu_of_x,CSv_of_x,CSw_of_x,CSt_of_x,CSbl_of_x,CSbt_of_x] = LS3DB_loads_sources_funs(FEMdata)      
...
for b=1:FEMdata.N_beams
    ...
    CSbl_of_x{b} = add_loads_and_sources(FEMdata.sources.CSbl{b},FEMdata.sources.akbl{b},FEMdata.L(b));     % Concentrated lateral rotation springs at x=akbl
    CSbt_of_x{b} = add_loads_and_sources(FEMdata.sources.CSbt{b},FEMdata.sources.akbt{b},FEMdata.L(b));     % Concentrated transverse rotation springs at x=akbt
end
