...
if isempty(varargin) % Unpack all data
    ...
    switch lower(varargin{1})
          case 'nodelem_vars'
              ...
              akbl = FEMdata.sources.akbl;
              akbt = FEMdata.sources.akbt;
              varargout = {props,warp_DOF,L,b_alpha,b_beta,b_gamma,Ne_b,element_order,elem_connect,elem_nodes,apx,apy,apz,amx,amy,amz,apa,apl,apt,atq,aml,amt,abm,akx,aky,akz,aku,akv,akw,akt,akbl,akbt};
        ...
        case 'bcs'
          ...
          case 'outputs'
              ...
              dzeta = FEMdata.funs.dzeta;
              % Outputs:
              varargout = {beam_theory,warp_DOF,props,scale,Ne,enn,n_div,DOF_u,DOF_v,DOF_w,DOF_phix,DOF_phiy,DOF_phiz,DOF_dphix,psi,dpsi,d2psi,d3psi,phi,dphi,d2phi,zeta,dzeta};         
        case 'plots'
            % General data
            unit_sys = FEMdata.unit_sys;
            warp_DOF = FEMdata.warp_DOF;
