...
for e=1:Ne         
    ...
    [e_dof_range,L0,beam,T0,Jac,props,Gamx,Gamy,Gamz,fx,qy,qz,mx,fa,ql,qt,tq,bm,cfl,cft,cf_on_element] = unpack_edata(edata,e,'global_matrices');
    ...
    for ni=1:enn
        for nj=ni:enn
            ...
            int_K_fun = @(xi) Jac * (B(ni,xi,L0,Jac,Gamx,Gamy,Gamz))' * D{beam}(xi,props) * B(nj,xi,L0,Jac,Gamx,Gamy,Gamz);
