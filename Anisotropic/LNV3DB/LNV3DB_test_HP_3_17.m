...
% Exercise 3.17 of HODGES & PIERCE -  Introduction to Structural Dynamics and Aeroelasticity - (2011)
...
L0 = 10; A0 = 1e9/E0; Iyy0 = 1e2/E0; Izz0 = 1e9*Iyy0; J0 = 1e9/G0; 
Is0 = 1e3/rho0; Gamma0 = 0/E0; e1_0 = 0; e2_0 = 0; Ks0y = 5/6; Ks0z = 5/6;
kappa = logspace(0,2,3); % Vector of kappa values                     
% Geometry 
...
exact_freqs = [1.5573, 16.2501; 2.96784, 19.3558; 3.44766, 21.6200]; % From Tables 3.12 and 3.13
rel_error_omega = 1 - norm_omega./exact_freqs

% Comments: the value of the normalized frequency for kappa=1 is exactly as
