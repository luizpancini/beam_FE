...
% Exercise 3.12 of HODGES & PIERCE -  Introduction to Structural Dynamics and Aeroelasticity - (2011)
...
norm_omega = SOLdata.omega(2:end)/sqrt((E0*Iyy0)/(rho0*A0*L0^4)); % Normalized frequencies
ref_freqs = [5.59332; 30.2258; 74.6389; 138.791];                 % Given answer
freq_rel_error = 1 - norm_omega./ref_freqs                        % Relative errors 

% Comments: the mode shape is exactly as shown in Figure 3.48, and the
% relative errors on the frequencies are essentially zero
